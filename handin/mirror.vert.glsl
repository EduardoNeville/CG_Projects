...
void main() {
    ...
    */
	...
	v2f_dir_from_camera = vec3(normalize(mat_model_view*vec4(vertex_position, 1))); // TODO calculate
	// transform normal to camera coordinates
	v2f_normal = mat_normals_to_view*vertex_normal; // TODO apply normal transformation
